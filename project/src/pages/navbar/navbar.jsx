          ...
          <nav className="flex flex-col w-70 h-screen justify-between bg-[#F0F4FF] p-6 ">
                <div>
                    ...
                    <div className="mt-25 text-[#53575E]">
                        <NavLink to="/dashboard" className={({ isActive }) => isActive ? "flex items-center gap-3 rounded-[10px] text-[15px] font-[700] bg-blue-100 text-blue-600 mb-5 h-14 p-3" : "flex items-center gap-3 text-[15px]  mb-5 font-[700] rounded-[10px] text-slate-600 hover:bg-[#DCE6FF] h-14 p-3"}>
